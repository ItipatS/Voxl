...
function module:Init(Settings)
	...
	module.Color = Settings.Color or Color3.new(1, 1, 1) -- read on each spawn; update live to recolour
...
function module:Create(Settings)
	...
	Trail.Color = ColorSequence.new(Settings.Color or module.Color)
